...
const rolePermissions = {
  ...
  school_admin: ["portal:view", "profile:view_own", "admin:shell:view"],
  finance: ["portal:view", "profile:view_own", "admin:shell:view"],
  ohb_admin: ["portal:view", "profile:view_own", "admin:shell:view"],
  hok_admin: ["portal:view", "profile:view_own", "admin:shell:view"],
  event_manager: ["portal:view", "profile:view_own", "admin:shell:view"],
